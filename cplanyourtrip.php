<?php 
				...
				*/
				...
				require_once("vplanyourtrip.php");
				...
				$pytobj= new PlanYourTrip(); //$pytobj->testObj();
				...
				$pytobj->setPList($data);
				$pytobj->htmlHead();

				$link=$pytobj->connect();
                $rs=$pytobj->selectRecords($fields = array("*"), $tables = array("highlight"), "");				
				$pytobj->pageBody($msg,$rs);
			?>