...
function bodycontent(){
	...
	$title="<center><big><big>CONTACT US</big></big></center>";
	$boxdata[0]=array("boxid"=>1, "boxtype"=>"titlec", "stylename"=>"titlec", "content"=>"$title");
	$contentl="<center><big><strong><p style=\"color: #2874a6;\" >Hela Rasa Osaka (Pvt.) Ltd</p></strong></big></BR></BR><img src=\"logo1.jpg\" alt=\"Osaka\" style=\"width:auto; height:20vh; box-sizing: border-box;\"/></center></BR></BR>
				<div style=\"display: flex; align-items: center; margin-bottom: 10px;\">
					<div style=\"flex: 0 0 25%;\">
						<img src=\"iconcall.png\" alt=\"Phone\" width=\"50\" height=\"50\">
					</div>
				...
				<div style=\"display: flex; align-items: center; margin-bottom: 10px;\">
					<div style=\"flex: 0 0 25%;\">
						<img src=\"iconemail.png\" alt=\"Email\" width=\"50\" height=\"50\">
					</div>
					<div style=\"flex: 0 0 65%;\">
					info.osaka@gmail.com
					</div>
				</div>

				<div style=\"display: flex; align-items: center; margin-bottom: 10px;\">
					<div style=\"flex: 0 0 25%;\">
						<img src=\"iconaddress.png\" alt=\"Address\" width=\"50\" height=\"50\">
					</div>
					<div style=\"flex: 0 0 65%;\">
				...
				<div style=\"display: flex; align-items: center; margin-bottom: 10px;\">
					<div style=\"flex: 0 0 25%;\">
						<img src=\"iconweb.png\" alt=\"Web\" width=\"50\" height=\"50\">
					</div>
					<div style=\"flex: 0 0 65%;\">
						www.HelaRasaOsaka.com
					</div>
				</div>
	...
	$form="<form name=\"formlog\" method=\"GET\" style=\" box-sizing: border-box;\" action=\"#\">
				...
				<p><input name=\"send\" type=\"submit\" value=\"Send\"  size=\"28\" style=\"width: 65%; box-sizing: border-box; border: 1.5px solid black; padding: 10px; background:  #45b39d ; color: Black; font-size: 1em; cursor: pointer;\"></p>
			</form>";
